...
import com.kemoiz.project0.fx.bloomshaders.BloomShaderLoader;
...
public class Bloom {
	...
	private void initialize(int FBO_W, int FBO_H, FrameBuffer fbo,
		...
		bloomShader = BloomShaderLoader.createShader("screenspace", alpha
				+ "bloom");
		...
		blurShader = BloomShaderLoader.createShader("blurspace", alpha
				+ "gaussian");

		setSize(FBO_W, FBO_H);
		setBloomIntensity(2.5f);
		setOriginalIntensity(0.8f);
		setTreshold(0.5f);
